...
public class PoliceWithShotgun : Police_Shooting
{
    public float SpreadAngleShotgun;
    ...
    public override IEnumerator Fire()
    {
        ...
        {
            float SpreadAngle = Random.Range(-SpreadAngleShotgun / 2, SpreadAngleShotgun / 2);
            Quaternion Rotation = Quaternion.Euler(0, 0, FirePoint.rotation.eulerAngles.z + SpreadAngle);
